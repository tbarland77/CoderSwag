package com.programmerz.timothy.coderswag.services

import com.programmerz.timothy.coderswag.model.Category
import com.programmerz.timothy.coderswag.model.Product

/**
 * Created by Timothy on 2/4/2018.
 */
object DataService {
    ...
    val hats = listOf(
            ...
            Product("Devslopes Snapback", "$22", "hat04")
    )

    val hoodies = listOf(
            Product("Devslopes Hoodie Gray", "$28", "hoodie01"),
            Product("Devslopes Hoodie Red", "$32", "hoodie02"),
            Product("Devslopes Gray Hoddie", "$28", "hoodie03"),
